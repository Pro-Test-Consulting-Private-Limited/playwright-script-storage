...
def run(playwright: Playwright) -> None:
    ...
    try:
        ...
        page.get_by_role("textbox", name="you@example.com").click()
        page.get_by_role("textbox", name="you@example.com").fill("9740487980")
        ...
        page.get_by_text("DashboardWalletKYCHistoryProfileLogout").click()
        page.get_by_role("link", name="KYC").click()
